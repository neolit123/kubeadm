...
// Validate ...
func (c *InitConfiguration) Validate() error {
	return ValidateInitConfiguration(c).ToAggregate()
}

// Validate ...
func (c *ClusterConfiguration) Validate() error {
	return ValidateClusterConfiguration(c).ToAggregate()
}

// Validate ...
func (*ClusterStatus) Validate() error {
	return nil
}

// Validate ...
func (c *JoinConfiguration) Validate() error {
	return ValidateJoinConfiguration(c).ToAggregate()
}

// ---------------------

// ValidateInitConfiguration validates an InitConfiguration object and collects all encountered errors
func ValidateInitConfiguration(c *InitConfiguration) field.ErrorList {
...
func ValidateClusterConfiguration(c *ClusterConfiguration) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	// NOTE for external types component config is not embedded
...
func ValidateAPIServer(a *APIServer, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateJoinConfiguration(c *JoinConfiguration) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateJoinControlPlane(c *JoinControlPlane, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if c != nil {
...
func ValidateNodeRegistrationOptions(nro *NodeRegistrationOptions, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if len(nro.Name) == 0 {
...
func ValidateDiscovery(d *Discovery, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateDiscoveryBootstrapToken(b *BootstrapTokenDiscovery, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	allErrs = append(allErrs, ValidateToken(b.Token, fldPath.Child(shared.TokenStr))...)
...
func ValidateDiscoveryFile(f *FileDiscovery, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateBootstrapTokens(bts []BootstrapToken, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	for i, bt := range bts {
...
func ValidateEtcd(e *Etcd, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidatePort(port int32, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if _, err := shared.ParsePort(strconv.Itoa(int(port))); err != nil {
...
func ValidateHostPort(endpoint string, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if _, _, err := shared.ParseHostPort(endpoint); endpoint != "" && err != nil {
...
func ValidateNetworking(c *ClusterConfiguration, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	isDualStack := shared.FeatureEnabled(c.FeatureGates, shared.IPv6DualStack)

	if len(c.Networking.ServiceSubnet) != 0 {
		allErrs = append(allErrs, ValidateIPNetFromString(c.Networking.ServiceSubnet, shared.MinimumAddressesInServiceSubnet, isDualStack, field.NewPath("serviceSubnet"))...)
	}
	if len(c.Networking.PodSubnet) != 0 {
		allErrs = append(allErrs, ValidateIPNetFromString(c.Networking.PodSubnet, shared.MinimumAddressesInServiceSubnet, isDualStack, field.NewPath("podSubnet"))...)
	}
	return allErrs
}
...
func ValidateAPIEndpoint(c *APIEndpoint, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateSocketPath(socket string, fldPath *field.Path) field.ErrorList {
	...
	} else if u.Scheme != DefaultURLScheme {
