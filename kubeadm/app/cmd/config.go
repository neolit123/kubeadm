...
import (
	...
	kubeadmscheme "k8s.io/kubeadm/app/apis/kubeadm/scheme"
	kubeadmapiv1beta2 "k8s.io/kubeadm/app/apis/kubeadm/v1beta2"
	"k8s.io/kubeadm/app/cmd/options"
	phaseutil "k8s.io/kubeadm/app/cmd/phases"
	cmdutil "k8s.io/kubeadm/app/cmd/util"
	"k8s.io/kubeadm/app/componentconfigs"
	...
	utilruntime "k8s.io/kubeadm/app/util/runtime"
...
func NewCmdConfigPrint(out io.Writer) *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: dedent.Dedent(`
			...
			For details, see: https://godoc.org/k8s.io/kubeadm/app/apis/kubeadm/v1beta2`),
